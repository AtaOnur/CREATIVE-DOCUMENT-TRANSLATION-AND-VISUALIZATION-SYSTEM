...
export function DocumentWorkspace({
  ...
  return (
    <div className="grid min-h-[520px] w-full flex-1 overflow-hidden border border-slate-200 bg-white shadow-sm lg:min-h-[calc(100dvh-5.5rem)] lg:grid-cols-[minmax(0,1fr)_340px]">
      ...
      <div className="flex min-h-0 min-w-0 flex-col overflow-hidden">
        ...
        <div ref={viewerRef} className="min-h-0 min-w-0 flex-1 overflow-auto bg-slate-200/60 p-4">
          {pdfLoadError ? (
            <p className="rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-800">
              {pdfLoadError}
            </p>
          ) : (
            <div className="mx-auto max-w-full min-w-0 w-full">
              <Document
                file={pdfUrl}
              ...
              >
                <div className="relative block w-full shadow-md overflow-auto min-w-0">
                  <Page
                    className="block min-w-0 max-w-full h-auto"
      ...
      <aside className="flex w-full flex-none flex-col border-t border-slate-200 bg-white lg:min-h-0 lg:overflow-y-auto lg:border-l lg:border-t-0">
        ...
        <div className="border-b border-slate-100 px-4 py-3">
          ...
          >
            {confirmedRegion && previewBoxStyle ? (
              <div
                className="pointer-events-none absolute border-2 border-emerald-600 bg-emerald-400/30"
              ...
              <div
                ...
                style={draftPreviewStyle}
              />
            ) : (
              <div className="flex h-full items-center justify-center text-xs text-slate-400">
                Henüz onaylı kutu yok
              </div>
            )}
          </div>
